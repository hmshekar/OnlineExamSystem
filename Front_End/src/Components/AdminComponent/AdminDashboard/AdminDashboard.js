...
import AddMcqQuestion from "./ExamComponent/AddQuestion/AddMcqQuestion";
import AddTrueFalseQuestion from "./ExamComponent/AddQuestion/AddTrueFalseQuestion";
import AddFbQuestion from "./ExamComponent/AddQuestion/AddFbQuestion";
      ...
      <BrowserRouter>
        ...
        <div id={style.content}>
          <div id={style.sideMenubar}>
            ...
            <div></div>
            <h4 className="text-white">Welcome Teacher</h4>
          ...
          <div id={style.display}>
            <Switch>
              ...
              <Route
                exact
                path="/AdminDashboard/Exam/AddMcqQuestion/:id"
                component={AddMcqQuestion}
              ></Route>
              {/* //AddTrueOrFalse */}
              <Route
                exact
                path="/AdminDashboard/Exam/AddTrueFalseQuestion/:id"
                component={AddTrueFalseQuestion}
              ></Route>
              <Route
                exact
                path="/AdminDashboard/Exam/AddFbQuestion/:id"
                component={AddFbQuestion}
              ></Route>
